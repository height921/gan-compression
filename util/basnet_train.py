...
from util.BASNet import BASNet
...
def muti_bce_loss_fusion(d1, d2, d3, d4, d5, d6, d7, labels_v):
    ...
    print("l1: %3f, l2: %3f, l3: %3f, l4: %3f, l5: %3f, l6: %3f\n" % (
     loss1.data[0], loss2.data[0], loss3.data[0], loss4.data[0], loss5.data[0], loss6.data[0]))
...
for epoch in range(0, epoch_num):
    ...
    for i, data in enumerate(salobj_dataloader):
        ...
        loss = muti_bce_loss_fusion(d1, d2, d3, d4, d5, d6, d7, labels_v)
        ...
        if ite_num % 2000 == 0:  # save model every 2000 iterations
            ...
            torch.save(net.state_dict(), model_dir + "basnet_bsi_itr_%d_train_%3f_tar.pth" % (
